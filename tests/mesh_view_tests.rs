...
mod mesh_view_tests {
    use kepler_wgpu::mesh::{
        mesh_view::{MeshView, FallbackMode},
    ...
    fn test_memory_tracking() {
        ...
        assert!(stats.frame_count < u64::MAX, "Frame count should be reasonable");
        assert!(stats.error_count < u64::MAX, "Error count should be reasonable");
