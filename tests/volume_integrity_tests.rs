...
mod volume_dimensions_tests {
    ...
    fn test_volume_max_dimensions_accepted() {
        let volume = CTVolume {
            dimensions: (2048, 2048, 2000),
            voxel_spacing: (0.5, 0.5, 0.5),
            voxel_data: vec![0i16; 2048 * 2048 * 2000],
            base: Base::default(),
        };
...
mod volume_data_consistency_tests {
    ...
    fn test_volume_data_size_mismatch_too_large() {
        ...
        let volume = CTVolume {
            dimensions: dims,
            voxel_spacing: (1.0, 1.0, 1.0),
            voxel_data: vec![0i16; expected_size + 100],
            base: Base::default(),
        };
...
mod volume_corruption_detection_tests {
    ...
    fn test_volume_unreasonably_large_data_detected() {
        ...
        let volume = CTVolume {
            ...
            voxel_data: unreasonably_large_data,
            base: Base::default(),
        };
