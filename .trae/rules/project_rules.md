...
2. Add function-level comments when generating code directly without displaying "Function-level comment: " prefix.
...
28. Alway keep in mind the Open Spec rules as following:
<!-- OPENSPEC:START -->
